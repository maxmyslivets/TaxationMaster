...
class MainWindow(QMainWindow):
    ...
    def setup_toolbars(self) -> None:
        ...
        self.ui.action_import_topographic_plan.triggered.connect(
            lambda x: Model.insert_taxation_data_from_autocad(self))
        ...
        self.ui.action_insert_protected_zones.triggered.connect(
            lambda x: Model.insert_protected_zones_from_autocad(self))
        ...
        self.ui.action_insert_table_exists_to_autocad.triggered.connect(
            lambda x: Model.insert_table_exists_to_autocad(self))
        self.ui.action_insert_table_removable_to_autocad.triggered.connect(
            lambda x: Model.insert_table_removable_to_autocad(self))
        self.ui.action_transform_m2cm.triggered.connect(lambda x: Model.transform_unit(self, m2cm=True))
        self.ui.action_transform_cm2m.triggered.connect(lambda x: Model.transform_unit(self, cm2m=True))
        self.ui.action_compress_size.triggered.connect(lambda x: Model.compress_size(self))
