...
class TaxationTool:
    ...
    def create_new_project(self) -> None:
        ...
        if not self.model.project.is_saved and not TaxationTool._confirm_close_unsaved_project():
            return
        ...
        try:
            ...
            self.model.project.path = self.temp_path / ("New project" + self.model.project.suffix)
            self.model.project.is_saved = True
    ...
    def convert_dwg_taxation_to_dxf(self) -> None:
        ...
        shutil.copyfile(self.model.project.path_dwg, self.temp_path_convert_input / dwg_path_without_space)
