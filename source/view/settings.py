...
class Settings(QDialog, Ui_Dialog):
    ...
    def __init__(self, config: Config) -> None:
        ...
        tab_system_settings.addRow(QLabel("Директория для входного файла конвертера"), self.temp_path_convert_input)
        self.temp_path_convert_output = QLineEdit(str(self.config.temp_path_convert_output))
        tab_system_settings.addRow(QLabel("Директория для выходного файла конвертера"), self.temp_path_convert_output)
