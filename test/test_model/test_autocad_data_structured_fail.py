...
def init_model_fail_duplicate_numbers_of_tree() -> Model:
    ...
    model.project.taxation_plan.path_dxf = "test_model/data/test_fail_duplicate_numbers_of_tree.dxf"
...
def init_model_fail_duplicate_numbers_of_shapes() -> Model:
    model = Model(log=log)
    model.project = Project()
    model.project.taxation_plan.path_dxf = "test_model/data/test_fail_duplicate_numbers_of_shapes.dxf"
    model.read_taxation_plan()
    return model
...
def init_model_fail_duplicate_numbers_tree_shapes() -> Model:
    model = Model(log=log)
    model.project = Project()
    model.project.taxation_plan.path_dxf = "test_model/data/test_fail_duplicate_numbers_tree-shapes.dxf"
    model.read_taxation_plan()
    return model
...
def init_model_fail_intersection_zone() -> Model:
    model = Model(log=log)
    model.project = Project()
    model.project.taxation_plan.path_dxf = "test_model/data/test_fail_intersection_zone.dxf"
    model.read_taxation_plan()
    return model
